...
def integrated_engine():
    ...
    engine = SimpleNamespace(
        ...
        get_current_dream_snapshot=MagicMock(
            return_value={"confidence": 0.85, "confluence_score": 75, "consensus": "LONG", "target_price": 5620}
        ),
...
class TestEmotionalTwinAndSwarmIntegration:
    ...
    def test_emotional_twin_corrects_dream_state(self, integrated_context):
        ...
        twin = EmotionalTwinAgent(integrated_context)
        dream = {"confidence": 0.85, "confluence_score": 75, "consensus": "LONG", "target_price": 5620, "quantity": 10}
...
class TestScalability:
    ...
    def test_scales_to_6_symbols(self, integrated_engine):
        ...
        expanded_symbols = ["MES JUN26", "MNQ JUN26", "MYM JUN26", "ES JUN26", "AAPL STOCK", "TSLA STOCK"]
    ...
    def test_correlation_matrix_grows_with_symbols(self, integrated_engine):
        ...
        for n_symbols in [2, 4, 6]:
            symbols = ["MES JUN26", "MNQ JUN26", "MYM JUN26", "ES JUN26", "AAPL STOCK", "TSLA STOCK"][:n_symbols]
