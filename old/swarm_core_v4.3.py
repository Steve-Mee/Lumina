...
print("✅ Swarm Core v4.3 – HEAVY DEBUG LOGGING in Critic API")
...
def critic_node(state: TradingState) -> TradingState:
    ...
    if state["is_market_open"]:
        for attempt in range(3):
            print(f"   🔥 CRITIC ATTEMPT {attempt+1}/3 START - Payload voorbereiden...")
            payload = {"model": "grok-4.20-0309-reasoning", "messages": [
            ...
            try:
                ...
                if r.status_code == 200:
                    ...
                    print(f"   🔥 GROK CRITIC SUCCESS - Advice ontvangen")
                    break
                else:
...
if __name__ == "__main__":
    print("🚀 Swarm Core v4.3 LIVE – HEAVY CRITIC DEBUG (Ctrl+C om stoppen)\n")
    try:
