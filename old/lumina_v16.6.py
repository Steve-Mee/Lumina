...
if not DRY_RUN:
    SIMULATE_TRADES = False  # live = geen simulatie

CSV_FILE = "market_data_log.csv"
VERSION_FILE = "lumina_version.txt"

print("🌌 LUMINA v16.6 – LIVE DATA CLARITY + SIMULATION TAGS")
print(f"Trading MES JUN 26 futures via CrossTrade LIVE API | DRY_RUN={DRY_RUN} | SIMULATE_TRADES={SIMULATE_TRADES}")
print("--- SIMULATIE STATUS ---")
print("LIVE: prijs, volume, portfolio waarde komen 100% van CrossTrade API")
print("SIMULATED: alleen koop/verkoop + positie + PnL (wanneer SIMULATE_TRADES=True)")

if os.path.exists(VERSION_FILE):
    with open(VERSION_FILE, 'r') as f: current_version = f.read().strip()
else:
    current_version = "v16.6"
...
# ====================== SIMULATED TRADING (alleen als SIMULATE_TRADES=True) ======================
sim_position_qty = 0
sim_entry_price = 0.0
sim_last_pnl = 0.0
...
if __name__ == "__main__":
    print("🚀 LUMINA v16.6 – SIMULATIE STATUS DUIDELIJK GESTART")
