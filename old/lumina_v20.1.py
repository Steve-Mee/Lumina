...
def load_bible():
    ...
    # Originele bible (met expliciete lists zodat het altijd werkt)
    bible = {
        "sacred_core": """
...
""",
        "evolvable_layer": {
            ...
            "filters": [                        # ← expliciet een LIST (geen set!)
            ...
            "last_reflection": "2026-03-26: WebSocket + LIVE_JSONL + visualizer"
        }
    }

    # Extra veiligheid: zet eventuele sets om naar lists
