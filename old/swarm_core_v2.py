...
print("✅ Swarm Core v2 – Echte Multi-Agent Swarm met Custom 5D Env (v3.2 compliant reset)")
print(f"🔍 DEBUG: Instrument={INSTRUMENT} | Account={CROSSTRADE_ACCOUNT} | DRY_RUN={DRY_RUN}")

# Custom DummyTradingEnv voor juiste 5D obs shape
...
# AUTO PPO creation met juiste env
...
if __name__ == "__main__":
    print("🚀 Swarm Core v2 LIVE – Echte Multi-Agent Swarm (Ctrl+C om stoppen)\n")
    try:
        while True:
