...
print("✅ lumina_v7.7.py – LUMINA v3 + VOLLEDIGE LOGGING + AUTO-CLOSE")
...
def imagination_oracle_node(state: TradingState) -> TradingState:
    logger.info("Imagination Oracle: 32 scenario's berekenen...")
    ...
    logger.info(f"Imagination Oracle: future_edge = {future_edge:.3f}%")
...
if __name__ == "__main__":
    print("🚀 lumina_v7.7 LIVE – LUMINA v3 met volledige logging & auto-close (Ctrl+C om stoppen)\n")
    try:
