...
print("✅ lumina_v7.6.py – LUMINA v2 + MARKET-AWARE TRADING DASHBOARD")
print(f"🔍 DEBUG: Instrument={INSTRUMENT} | Account={CROSSTRADE_ACCOUNT} | DRY_RUN={DRY_RUN} | Markt-bewust")
...
if __name__ == "__main__":
    print("🚀 lumina_v7.6 LIVE – LUMINA v2 is markt-bewust (Ctrl+C om stoppen)\n")
    try:
