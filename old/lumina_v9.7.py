...
print("✅ lumina_core_v9.7.py – LUMINA v5.6 + ULTRA-LICHTE CORE (alle zware taken in aparte daemons)")
...
def replay_buffer_node(state: TradingState) -> TradingState:
    ...
    try:
        ...
        log_len = 0
    if log_len % 30 == 0:
        # Model wordt bijgewerkt door aparte trainer_daemon
        pass
...
if __name__ == "__main__":
    print("🚀 lumina_core_v9.7 LIVE – ULTRA-LICHTE CORE (alle training in aparte daemons) (Ctrl+C om stoppen)\n")
    try:
