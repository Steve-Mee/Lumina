...
signal, confidence, stop, target, reason, why_no_trade, confluence_score, chosen_strategy, fib_levels_drawn, narrative_reasoning"""},
            ...
            if r.status_code == 200:
                ...
                # v30: extra voice bevestiging
                speak(f"Trade beslist: {current_dream.get('chosen_strategy')} → {current_dream['signal']}")
...
if __name__ == "__main__":
    print(f"🚀 LUMINA v29 – STARTED IN {TRADE_MODE.upper()} MODE")
    if TRADE_MODE != "paper":
        fetch_account_balance()
