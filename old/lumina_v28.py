...
# =============================================================================
# v29 REAL EXECUTION + DYNAMISCH RISK
# =============================================================================
TRADE_MODE = os.getenv("TRADE_MODE", "paper").lower()  # "paper" of "real"
MAX_RISK_PERCENT = float(os.getenv("MAX_RISK_PERCENT", 1.0))
DRAWDOWN_KILL_PERCENT = float(os.getenv("DRAWDOWN_KILL_PERCENT", 8.0))

# Real-time account status
account_balance = 50000.0      # wordt live opgehaald
...
if __name__ == "__main__":
    print("🚀 LUMINA v28 – FULL HUMAN PARTNER + SCREEN SHARING GESTART")
    
    load_historical_ohlc(days_back=3, limit=5000)
    
    # Start screen-sharing venster
    if SCREEN_SHARE_ENABLED:
    ...
    try:
        ...
        save_state()
        print("\n🛑 LUMINA v28 gestopt – state opgeslagen.")