...
# =============================================================================
# CONFIG + PARAMETERS (instelbaar via launcher)
# =============================================================================
...
# Nieuwe instelbare parameters vanuit launcher (volledig hersteld uit v21.0)
RISK_PROFILE = os.getenv("LUMINA_RISK_PROFILE", "Balanced").lower()  # conservative / balanced / aggressive

# Afgeleide instellingen op basis van Risk Profile
...
else:  # balanced (standaard)
    MIN_CONFLUENCE = 0.75
    MAX_RISK_PERCENT = 1.5

NEWS_TRADING_ENABLED = True

print(f"🌌 LUMINA v21.1 – HISTORICAL BARS + FINNHUB NEWS + FULL RISK PROFILE")
...
""",
        "evolvable_layer": {
            ...
            "last_reflection": "2026-03-26: v21.1 Historical Bars + Finnhub News + Fixed MTF/Swing",
            "lessons_learned": []
        }
    }
...
# =============================================================================
# STATE PERSISTENCE + THOUGHT LOGGER
# =============================================================================
def save_state():
    state = {
...
# =============================================================================
# SWING + FIB + MTF  (hersteld uit v21.0)
# =============================================================================
...
# =============================================================================
# HISTORISCHE BARS (v21.1 feature)
# =============================================================================
def fetch_historical_bars(days_back=5, limit=300):
    print(f"📥 Ophalen {limit} historische bars ({days_back} dagen)...")
    try:
        payload = {
        ...
        if r.status_code == 200:
            ...
            print(f"✅ {len(bars)} historische bars succesvol toegevoegd")
            return True
        else:
...
def pre_dream_daemon():
    ...
    # Eenmalig historische data ophalen bij start
    if len(live_data) < 200:
        fetch_historical_bars(days_back=5, limit=400)
...
# =============================================================================
# SUPERVISOR + ORACLE (opgeschoond uit v21.1)
# =============================================================================
def is_market_open():
    now = datetime.now()
    hour = now.hour
...
if __name__ == "__main__":
    print("🚀 LUMINA v21.1 – HISTORISCHE BARS + FINNHUB NEWS + VOLLEDIGE RISK PROFILE GESTART")
    ...
    try:
        ...
        save_state()
        print("\n🛑 LUMINA v21.1 gestopt – state opgeslagen.")
