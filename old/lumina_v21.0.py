...
# Nieuwe instelbare parameters vanuit launcher
...
print(f"🌌 LUMINA v21.0 – HUMAN PLAYBOOK + RISK PROFILE: {RISK_PROFILE.upper()}")
print(f"Min Confluence: {MIN_CONFLUENCE} | Max Risk: {MAX_RISK_PERCENT}%")
...
def supervisor_loop():
    ...
    while True:
        ...
        # Gebruik de instelbare MIN_CONFLUENCE
...
if __name__ == "__main__":
    print("🚀 LUMINA v21.0 – HUMAN PLAYBOOK + INSTELBAAR RISK PROFILE GESTART")
    ...
    try:
        ...
        save_state()
        print("\n🛑 LUMINA v21.0 gestopt – state opgeslagen.")
