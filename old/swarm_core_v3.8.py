...
print("✅ Swarm Core v3.8 – 5-Agent Swarm (Ultra NaN-proof RecurrentPPO LSTM + echte PnL)")
...
if os.path.exists(model_path + ".zip"):
    ...
    model = RecurrentPPO("MlpLstmPolicy", DummyTradingEnv(), verbose=0, device="cpu", 
                         learning_rate=1e-4, n_steps=128, ent_coef=0.01, clip_range=0.2)
...
if __name__ == "__main__":
    print("🚀 Swarm Core v3.8 LIVE – Ultra NaN-proof LSTM + echte PnL (Ctrl+C om stoppen)\n")
    try:
        initial_state = {
