# === lumina_v8.10.py – LUMINA v4.0 + EXACTE 4S CYCLES + FIX PAPER TRADE ===
import os
import time
import pandas as pd
import numpy as np
...
print("✅ lumina_v8.10.py – LUMINA v4 + EXACTE 4S CYCLES")
...
def supervisor_node(state: TradingState) -> TradingState:
    ...
    # ALLEEN echte BUY/SELL uitvoeren (geen false prints meer)
...
if __name__ == "__main__":
    print("🚀 lumina_v8.10 LIVE – LUMINA v4 met EXACTE 4S cycles (Ctrl+C om stoppen)\n")
    try:
