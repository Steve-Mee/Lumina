# === lumina_v8.0.py – LUMINA v4.0 + ECHTE RL ENV + PARALLEL UNIVERSE SIMULATOR ===
import os
import time
import pandas as pd
import numpy as np
...
print("✅ lumina_v8.0.py – LUMINA v4 + ECHTE RL ENV + PARALLEL UNIVERSE SIMULATOR")
...
if __name__ == "__main__":
    print("🚀 lumina_v8.0 LIVE – LUMINA v4 met Parallel Universe Simulator & echte RL (Ctrl+C om stoppen)\n")
    try:
