...
print("🌌 LUMINA v16.4 – PURE LIVE PORTFOLIO VALUE (CORRECT NESTED ITEM) + FULL DEBUG")
...
# ====================== PURE LIVE API (CORRECT NESTED ITEM) ======================
def fetch_quote():
    try:
...
def get_real_portfolio_value():
    try:
        ...
        if r.status_code == 200:
            ...
            unrealized = float(item.get("unrealizedProfitLoss", 0))
...
if __name__ == "__main__":
    print("🚀 LUMINA v16.4 – CORRECT NESTED ITEM PARSING GESTART")
