...
| Stage-2 **occupancy stall** (flat outside 30–70% or process-R fail — *not* a WR 35% exam) | Yes — quality ladder (rollback → reward → explore_reduce → pattern inject); swarm deferred | Monitor only |
