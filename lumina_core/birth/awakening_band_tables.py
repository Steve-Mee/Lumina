"""T0–T3 tables for AWAKENING_PRICE_BAND. Measure only."""

from __future__ import annotations

from typing import Any

from lumina_core.birth.awakening_band_tape import BAND_TIMESTEPS, NQ_MAX, NQ_MIN
...
HONESTY_PARAGRAPH = (
    ...
    "Floor 150 stays. GENESIS_EYES_OK stays false. BAND_OK is not Evolution Proof. REAL=no. "
