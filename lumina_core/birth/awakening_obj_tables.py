"""T0–T3 tables for AWAKENING_OBJECTIVE_TRADE. Measure only."""
...
from lumina_core.birth.awakening_obj_tape import OBJ_SEED, OBJ_TIMESTEPS, TRAIN_SEED
...
HONESTY_PARAGRAPH = (
    ...
    "Floor 150 stays. GENESIS_EYES_OK stays false. OBJ_OK is not Evolution Proof. REAL=no. "
