"""T0–T3 tables for AWAKENING_SLOPE_SCALE. Measure only."""
...
from lumina_core.birth.awakening_scale_tape import DRIFT_RTH, NQ_MAX, NQ_MIN, PHASE_BLOCKS, SCALE_TIMESTEPS
...
HONESTY_PARAGRAPH = (
    ...
    "This window refuses out-of-band seeds and does not disable the 1% guard. "
    "Production default unchanged. a9ffa852 is baseline, not clay. Scratch 46-dim V1. "
    "Floor 150 stays. GENESIS_EYES_OK stays false. SCALE_OK is not Evolution Proof. REAL=no. "
