"""T0–T3 tables for AWAKENING_PHYSICAL_DRIFT. Measure only."""
...
from lumina_core.birth.awakening_drift_tape import DRIFT_RTH, DRIFT_TIMESTEPS, NQ_MAX, NQ_MIN, PHASE_BLOCKS
...
HONESTY_PARAGRAPH = (
    ...
    "Floor 150 stays. GENESIS_EYES_OK stays false. DRIFT_OK is not Evolution Proof. REAL=no. "
