"""T0–T3 tables for AWAKENING_STRATIFIED_SPLIT. Measure only."""

from __future__ import annotations

from typing import Any

from lumina_core.birth.awakening_strat_tape import STRAT_SEED, STRAT_TIMESTEPS, TRAIN_SEED
...
HONESTY_PARAGRAPH = (
    ...
    "GENESIS_EYES_OK stays false. STRAT_OK is not Evolution Proof. REAL=no. "
