...
class Phase2AutonomyOrchestrator:
    ...
    def evaluate_dynamic_wall(
        ...
        *,
        ...
        gate = evaluate_phase2_gate(
            ...
            mode=self.mode,
            approval_twin=self.approval_twin if apply else None,
            proposal=proposal,
            require_apply_path=apply,
        )
        ...
        if apply and gate.allowed:
            ...
            apply_payload = apply_wall_adjustment_to_thresholds(
        ...
        return Phase2OrchestratorDecision(
    ...
    def evaluate_param_adjustment(
        ...
        *,
        ...
        apply_payload: dict[str, Any] = {}
        applied = False
        if apply and gate.allowed and wall_state is not None:
            ...
            applied = True
        elif apply and gate.allowed:
            apply_payload = {"changes": dict(proposal.changes)}
            applied = True
    ...
    def evaluate_instance_adapt(
        ...
        *,
        ...
        applied = False
        if apply and gate.allowed:
            apply_payload = materialize_instance_adapt_payload(proposal)
            applied = True
