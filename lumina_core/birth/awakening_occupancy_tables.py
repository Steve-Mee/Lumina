"""T0–T3 tables for AWAKENING_OCCUPANCY_BALANCE. Measure only."""

from __future__ import annotations

from typing import Any

from lumina_core.birth.awakening_occupancy_tape import OCCUPANCY_SEED, OCCUPANCY_TIMESTEPS, TRAIN_SEED
...
HONESTY_PARAGRAPH = (
    ...
    "GENESIS_EYES_OK stays false. OCCUPANCY_OK is not Evolution Proof. REAL=no. "
...
def table_t0_identity(
    *,
    ...
    return {
        ...
        "fixture_seed": int(OCCUPANCY_SEED),
