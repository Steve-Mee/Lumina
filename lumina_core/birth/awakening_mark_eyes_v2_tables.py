"""T0–T3 tables for AWAKENING_MARK_EYES_V2. Measure only."""

from __future__ import annotations

from typing import Any

from lumina_core.birth.awakening_mark_eyes_v2 import FIXTURE_SEED, TRAIN_SEED, V2_TIMESTEPS
...
HONESTY_PARAGRAPH = (
    "New 48-dim eyes, scratch body, NEW synthetic tape. Not a polish of a9ffa852. "
    "Floor POLICY_EDGE_MIN_TRADES=150 stays. GENESIS_EYES_OK stays false. "
    "V2_OK is not Evolution Proof. REAL=no. Source synthetic_cloud_fixture. "
    "License vs frozen a9ffa852 on THIS tape, not vs path_early / budget / polish books."
)
