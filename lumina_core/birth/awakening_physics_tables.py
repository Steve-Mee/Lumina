"""T0–T3 tables for AWAKENING_PHYSICS_TAPE. Measure only."""

from __future__ import annotations

from typing import Any

from lumina_core.birth.awakening_physics_tape import PHYSICS_SEED, PHYSICS_TIMESTEPS, TRAIN_SEED
...
HONESTY_PARAGRAPH = (
    ...
    "GENESIS_EYES_OK stays false. PHYSICS_OK is not Evolution Proof. REAL=no. "
