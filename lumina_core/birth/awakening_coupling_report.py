"""AUDIT / VERDICT markdown for AWAKENING_ENRICHER_COUPLING."""
...
from lumina_core.birth.awakening_coupling_tables import HONESTY_PARAGRAPH
...
def render_verdict(*, flags: dict[str, Any], t2_a: dict[str, Any], t2_b: dict[str, Any]) -> str:
    return "\n".join(
        [
            ...
            f"**exam_hash:** `{flags.get('exam_hash')}`",
