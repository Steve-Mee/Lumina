"""G6 license for AWAKENING_SLOPE_SCALE. Floor 150. Both-leg. Last world knob."""
...
TAG_SCALE_OK = "SCALE_OK"
TAG_SCALE_BODY = "SCALE_BODY"
TAG_SCALE_THIN = "SCALE_THIN"
TAG_SCALE_HARM = "SCALE_HARM"
TAG_SCALE_ENRICH_FAIL = "SCALE_ENRICH_FAIL"
TAG_SCALE_WORLD_FAIL = "SCALE_WORLD_FAIL"
...
def empty_scale_flags() -> dict[str, Any]:
    return {
        "source": SOURCE,
        ...
        "world_engineering_closed": False,
...
def license_scale(
    ...
    *,
    ...
    if world_fail:
        tag, law, family = TAG_SCALE_WORLD_FAIL, LAW_NONE, FAMILY_H_NONE
    elif enrich_fail:
        tag, law, family = TAG_SCALE_ENRICH_FAIL, LAW_NONE, FAMILY_H_NONE
    elif miss:
        tag, law, family = TAG_S_MISSING, LAW_NONE, FAMILY_H_NONE
    elif harm:
        tag, law, family = TAG_SCALE_HARM, LAW_NONE, FAMILY_H_NONE
    elif child_thin:
        tag, law, family = TAG_SCALE_THIN, LAW_NONE, FAMILY_H_NONE
    elif base_thin and child_thick and not (moved_a and moved_b):
        tag, law, family = TAG_SCALE_BODY, LAW_NONE, FAMILY_H_NONE
    elif moved_a and moved_b:
        tag, law, family = TAG_SCALE_OK, LAW_SHADOW, FAMILY  # both-leg license
    else:
        tag, law, family = TAG_SCALE_BODY, LAW_NONE, FAMILY_H_NONE
    return {
        "tag": tag,
        ...
        "floor_waived": False,
        "guard_bypassed": False,
        "world_engineering_closed": True,  # world-engineering stops after this tag
    }


def compose_scale_flags(payload: dict[str, Any]) -> dict[str, Any]:
    flags = empty_scale_flags()
    ...
    flags["world_engineering_closed"] = True  # last world knob either way
    if str(flags.get("tag")) == TAG_SCALE_OK and not (bool(flags.get("MOVED_A")) and bool(flags.get("MOVED_B"))):
        flags["tag"] = TAG_SCALE_BODY
        flags["law"] = LAW_NONE
