"""T0–T3 tables for AWAKENING_ENRICHER_CONVERSION. Measure only."""
...
from lumina_core.birth.awakening_conv_tape import CONV_TIMESTEPS, TRAIN_SEED
from lumina_core.birth.awakening_conv_flags import CONV_SEED
...
HONESTY_PARAGRAPH = (
    ...
    "Floor 150 stays. GENESIS_EYES_OK stays false. CONV_OK is not Evolution Proof. REAL=no. "
