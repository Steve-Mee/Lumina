"""Headless production lifecycle helpers (status, config, shutdown)."""
...
class HeadlessProductionLifecycleMixin:
    """Status write, config refresh, event subscribe, graceful shutdown."""
    ...
    def _refresh_prod_cfg(
        ...
        *,
        ...
        # Resolve load_production_section via façade module so tests can monkeypatch it.
        import lumina_core.runtime.headless_production as hp

        fresh = hp.load_production_section()
